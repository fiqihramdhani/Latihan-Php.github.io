      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navigation">
            ...
            <form action="tables.php" method="POST" autocomplete="OFF" action="">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="Input.php">"Input Barang Dagangan"</a>
                <br></br>
              </div>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <a   class="btn btn-primary btn-round" href="Pendapatan.php?id=<?php echo $row['ID'] ;?>"  
